...
Z_MENLIST = [];
  ...
  //  	     Z_VEHCLASSES = Z_VEHCLASSES + [[_vehicleClass,_picture,_configName]];
            Z_VEHLIST = Z_VEHLIST + [[_vehicleClass,_picture,_configName]];
    	   };
    	   if (_simulation in Z_STATICCLASSES) then {
            Z_STATICLIST = Z_STATICLIST + [[_vehicleClass,_picture,_configName]];
    	   };
    	   if (_simulation in Z_MENCLASSES) then {
            Z_MENLIST = Z_MENLIST + [[_vehicleClass,_picture,_configName]];
    	   };
  	   };
  	};
